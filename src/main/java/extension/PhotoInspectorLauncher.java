...
public class PhotoInspectorLauncher extends ExtensionFormCreator {

    public ExtensionForm createForm(Stage primaryStage) throws Exception {

        FXMLLoader loader = new FXMLLoader(getClass().getResource("photoinspector.fxml"));
        Parent root = loader.load();

        primaryStage.setTitle("Sanbovir Photo Inspector");
